...
public class MainGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(g.getGrid_item_img()==null){

        }else{
            grid_item_img.setImageBitmap(g.getGrid_item_img());
        }
    ...
    //순서 : 그림 이름 가격
    public void addGridItem(String register_number, String grid_item_name, String grid_item_price, Bitmap grid_item_img){
        MainGridItem g = new MainGridItem(register_number,grid_item_name,grid_item_price, grid_item_img);
