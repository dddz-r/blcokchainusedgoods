...
public class Category6  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Category6.objectGrid og = new Category6.objectGrid("자동차 기기"); //카테고리 전체라서 일단 *넣어둠
        og.execute();
        ...
        category_grid.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent = new Intent(Category6.this, BuyScreen.class);
        ...
        category_grid.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        startActivity(new Intent(Category6.this, BuyScreen.class));
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                while(count < jsonArray.length()){
                    ...
                    Category6.objectGridBlock ogb = new Category6.objectGridBlock(register_number); //카테고리 전체라서 일단 *넣어둠
                    ogb.execute();
