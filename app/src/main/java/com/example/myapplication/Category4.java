...
public class Category4  extends AppCompatActivity {
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        startActivity(new Intent(Category4.this, MainActivity.class));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Category4.objectGrid og = new Category4.objectGrid("게임기"); //카테고리 전체라서 일단 *넣어둠
        og.execute();
        ...
        category_grid.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent = new Intent(Category4.this, BuyScreen.class);
        ...
        category_grid.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        startActivity(new Intent(Category4.this, BuyScreen.class));
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                while(count < jsonArray.length()){
                    ...
                    Category4.objectGridBlock ogb = new Category4.objectGridBlock(register_number); //카테고리 전체라서 일단 *넣어둠
                    ogb.execute();
