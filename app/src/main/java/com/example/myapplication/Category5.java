...
public class Category5  extends AppCompatActivity {
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        startActivity(new Intent(Category5.this, MainActivity.class));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryTitle.setText("생활/주방/미용 가전");
        ...
        Category5.objectGrid og = new Category5.objectGrid("생활/주방/미용 가전"); //카테고리 전체라서 일단 *넣어둠
        og.execute();
        ...
        category_grid.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent = new Intent(Category5.this, BuyScreen.class);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                while(count < jsonArray.length()){
                    ...
                    Category5.objectGridBlock ogb = new Category5.objectGridBlock(register_number); //카테고리 전체라서 일단 *넣어둠
                    ogb.execute();
