...
public class Category7  extends AppCompatActivity {
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        startActivity(new Intent(Category7.this, MainActivity.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryTitle.setText("기타 전자 기기");
        ...
        Category7.objectGrid og = new Category7.objectGrid("기타 전자 기기"); //카테고리 전체라서 일단 *넣어둠
        og.execute();
        ...
        category_grid.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent = new Intent(Category7.this, BuyScreen.class);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                while(count < jsonArray.length()){
                    ...
                    Category7.getImg gi = new Category7.getImg(register_number, object_name, object_price, "0");
                    gi.execute();
